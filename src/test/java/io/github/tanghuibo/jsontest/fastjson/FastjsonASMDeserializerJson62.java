...
public class FastjsonASMDeserializerJson62 extends JavaBeanDeserializer {
    ...
    public FastjsonASMDeserializerJson62(ParserConfig var1, JavaBeanInfo var2) {
        super(var1, var2);
    }
    ...
    public Object deserialze(DefaultJSONParser var1, Type var2, Object var3, int var4) {
        ...
        if (var5.token() == 14 && var5.isEnabled(var4, 8192)) {
        ...
        } else if (var5.isEnabled(512) && var5.scanType("io.github.tanghuibo.test.Json62") != -1) {
            Json62 var8;
            int var12;
            int var13;
            String var15;
            ...
            label1611: {
                ...
                if (var5.matchStat != 4) {
                    ...
                    label1613: {
                        ...
                        var74 = var5.scanFieldString(this.testFiled7_asm_prefix__);
                        if (var5.matchStat > 0) {
                            var13 |= 134217728;
                        }
                        ...
                        var75 = var5.scanFieldString(this.testFiled8_asm_prefix__);
                        if (var5.matchStat > 0) {
                            var13 |= 268435456;
                        }
                        ...
                        var76 = var5.scanFieldString(this.testFiled9_asm_prefix__);
                        if (var5.matchStat > 0) {
                            var13 |= 536870912;
                        }
                    ...
                    if ((var13 & 134217728) != 0) {
                        var8.setTestFiled7(var74);
                    }

                    if ((var13 & 268435456) != 0) {
                        var8.setTestFiled8(var75);
                    }

                    if ((var13 & 536870912) != 0) {
                        var8.setTestFiled9(var76);
                    }
                }
            ...
            return (Json62)this.parseRest(var1, var2, var3, var8, var4, new int[]{var12, var13});
        } else {
    ...
    public Object deserialzeArrayMapping(DefaultJSONParser var1, Type var2, Object var3, Object var4) {
        JSONLexerBase var71 = (JSONLexerBase)var1.lexer;
        String var5 = var71.scanTypeName(var1.getSymbolTable());
        if (var5 != null) {
            ...
            if (var6 instanceof JavaBeanDeserializer) {
                return var6.deserialzeArrayMapping(var1, var2, var3, var71);
            }
        }

        Json62 var7 = new Json62();
        String var8 = var71.scanString(',');
        String var9 = var71.scanString(',');
        String var10 = var71.scanString(',');
        String var11 = var71.scanString(',');
        String var12 = var71.scanString(',');
        String var13 = var71.scanString(',');
        String var14 = var71.scanString(',');
        String var15 = var71.scanString(',');
        String var16 = var71.scanString(',');
        String var17 = var71.scanString(',');
        String var18 = var71.scanString(',');
        String var19 = var71.scanString(',');
        String var20 = var71.scanString(',');
        String var21 = var71.scanString(',');
        String var22 = var71.scanString(',');
        String var23 = var71.scanString(',');
        String var24 = var71.scanString(',');
        String var25 = var71.scanString(',');
        String var26 = var71.scanString(',');
        String var27 = var71.scanString(',');
        String var28 = var71.scanString(',');
        String var29 = var71.scanString(',');
        String var30 = var71.scanString(',');
        String var31 = var71.scanString(',');
        String var32 = var71.scanString(',');
        String var33 = var71.scanString(',');
        String var34 = var71.scanString(',');
        String var35 = var71.scanString(',');
        String var36 = var71.scanString(',');
        String var37 = var71.scanString(',');
        String var38 = var71.scanString(',');
        String var39 = var71.scanString(',');
        String var40 = var71.scanString(',');
        String var41 = var71.scanString(',');
        String var42 = var71.scanString(',');
        String var43 = var71.scanString(',');
        String var44 = var71.scanString(',');
        String var45 = var71.scanString(',');
        String var46 = var71.scanString(',');
        String var47 = var71.scanString(',');
        String var48 = var71.scanString(',');
        String var49 = var71.scanString(',');
        String var50 = var71.scanString(',');
        String var51 = var71.scanString(',');
        String var52 = var71.scanString(',');
        String var53 = var71.scanString(',');
        String var54 = var71.scanString(',');
        String var55 = var71.scanString(',');
        String var56 = var71.scanString(',');
        String var57 = var71.scanString(',');
        String var58 = var71.scanString(',');
        String var59 = var71.scanString(',');
        String var60 = var71.scanString(',');
        String var61 = var71.scanString(',');
        String var62 = var71.scanString(',');
        String var63 = var71.scanString(',');
        String var64 = var71.scanString(',');
        String var65 = var71.scanString(',');
        String var66 = var71.scanString(',');
        String var67 = var71.scanString(',');
        String var68 = var71.scanString(',');
        String var69 = var71.scanString(']');
        var7.setTestFiled9(var69);
        var7.setTestFiled10(var10);
        var7.setTestFiled0(var8);
        var7.setTestFiled7(var67);
        var7.setTestFiled1(var9);
        var7.setTestFiled6(var64);
        var7.setTestFiled11(var11);
        var7.setTestFiled12(var12);
        var7.setTestFiled8(var68);
